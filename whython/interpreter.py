...
class Interpreter:
    ...
    def visit_BinOpNode(self, node, context):
        ...
        if node.op_tok.type == TT_PLUS:
            ...
            result, error = left.exponent_by(right)
        ...
        elif node.op_tok.matches(TT_KEYWORD, KEYWORDS_DICT["and"]):
            result, error = left.anded_by(right)
        elif node.op_tok.matches(TT_KEYWORD, KEYWORDS_DICT["or"]):
    ...
    def visit_UnaryOpNode(self, node, context):
        ...
        elif node.op_tok.matches(TT_KEYWORD, KEYWORDS_DICT["not"]):
    ...
    def visit_ForNode(self, node, context):
        ...
        return res.success(
            Number.ignore if node.should_return_null else
